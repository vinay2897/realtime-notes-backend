...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.send = function (message) {
        this.sent.push(message);
        this.socket.send(message);
    };
    AppComponent.prototype.connect = function () {
        var _this = this;
        var url = "ws://192.168.31.160:3000/";
    ...
    AppComponent.prototype.setCookie = function () {
        this.http.post("http://localhost:3001/set-cookie", {}, { withCredentials: true }).subscribe(function (data) {
            console.log(data);
        }, function (err) {
            console.log(err);
        });
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.createNote = function () {
        return this.http.post(this.httpServerUrl + "/create-note", {}, { withCredentials: true });
    };
    AuthService.prototype.setRid = function (content) {
        return this.http.post(this.httpServerUrl + "/test-redis", { content: content }, { withCredentials: true });
    };
    AuthService.prototype.shareNote = function (shareWith) {
    ...
    AuthService.prototype.accessNote = function (rid) {
        return this.http.post(this.httpServerUrl + "/access-notes", { rid: rid }, { withCredentials: true });
    };
...
var ProfileComponent = /** @class */ (function () {
    ...
    ProfileComponent.prototype.createNote = function () {
        var _this = this;
        this.loading = true;
        this.authService.createNote().subscribe(function (res) {
            console.log(res);
            // if(res["rid"]){
            _this.loading = false;
            //   this.create = true;
    ...
    ProfileComponent.prototype.shareNote = function () {
        this.authService.shareNote(this.shareForm.value).subscribe(function (res) {
            console.log(res);
        }, function (err) {
            console.log(err);
        });
    };
    ProfileComponent.prototype.getAllNotes = function () {
        var _this = this;
        this.authService.getAllNotes().subscribe(function (res) {
            console.log(res);
            _this.allNotes = res["my_notes"];
        }, function (err) {
            console.log(err);
        });
    };
    ProfileComponent.prototype.accessNote = function (rid) {
        var _this = this;
        this.authService.accessNote(rid).subscribe(function (res) {
            console.log(res);
            if (res["rid"]) {
                _this.currentNote = res["rid"];
    ...
    ProfileComponent.prototype.connectWebsocket = function () {
        var _this = this;
        if (this.socket) {
            this.socket.close();
        }
        ...
        this.socket.onmessage = function (event) {
            // console.log(event.data)
            _this.note = event.data;
        };
    };
    ProfileComponent.prototype.test = function (content) {
